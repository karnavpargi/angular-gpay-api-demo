...
export class GooglePayButtonDirective implements OnInit, OnChanges {
  ...
  buttonType?: google.payments.api.ButtonType = 'short';
  buttonSizeMode?: google.payments.api.ButtonSizeMode = 'fill';
  constructor(private elementRef: ElementRef) {
    // For production please add "PRODUCTION"
